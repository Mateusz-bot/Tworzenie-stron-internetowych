...
var moves = 0;
var couter = 32;
var punkty = "Liczba punktów";
var ruchy = "Liczb ruchów";
var liczbaruchow = "Pozostalo ruchow";
generateImgs();
generateTable();
updateScore();
updateMoves();
...
function updateScore() {
    document.getElementById('score')
        .innerHTML = punkty + " " + score;
}

function updateMoves() {
    document.getElementById('moves').innerHTML = ruchy + " " + moves;
}

function updateMaxMoves() {
    document.getElementById('couter').innerHTML = liczbaruchow + " " + couter;
}
